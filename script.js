...
if (countEl) countEl.textContent = `${questions.length}-question ENT quiz (20 extracted PYQs + ${questions.length - 20} additional practice questions)`;
const imageQuestionCount = questions.filter((q) => q.image).length;
if (imageCountEl) imageCountEl.textContent = `${imageQuestionCount} questions`;
...
function renderQuiz() {
  ...
  questions.forEach((q, i) => {
    ...
    if (q.image) {
      ...
      tag.textContent = "Image-based question";
